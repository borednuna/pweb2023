    ...
    if (empty($errorMessage)) {
        ...
        if ($uploadOk == 0) {
            ...
            if (move_uploaded_file($_FILES["foto"]["tmp_name"], $targetFile)) {
                ...
                $result = mysqli_query($conn, "INSERT INTO student_registration (nis, nama, jenis_kelamin, telp, alamat, foto) VALUES ('$nis', '$nama', '$jenis_kelamin', '$telp', '$alamat', '$targetFile')");
